...
// Each concrete event class is assigned exactly one of these and exposes it as
// `event.eventType`. The bus uses these values as map keys, which gives
...
// covered - add a new EventType member and the build fails until you name it.
